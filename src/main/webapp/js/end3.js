...
console.log("d1:"+d1);//neg
  ...
  var d3_time_days = [ "Sunday", "Monday", "Tuesday", "Wensday", "Thursday", "Friday", "Saturday" ], d3_time_dayAbbreviations = [ "Sun", "Mon", "Tue", "Wen", "Thu", "Fri", "Sat" ], d3_time_months = ["January", "Feburay", "March", "April", "May", "June", "July", "August", "Septemday", "October", "November","December"], d3_time_monthAbbreviations = [ "Jan", "Feb","Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ];
